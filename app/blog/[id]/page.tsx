...
//           {/* FAKE CONTENT (Replace with real CMS later) */}
//           <div className="mt-6 space-y-4 text-gray-600 text-sm sm:text-base leading-relaxed">
//             <p>
//               Kansas City continues to be one of the most attractive real estate
//               markets due to affordability, lifestyle, and growth opportunities.
//             </p>

//             <p>
//               When selling a home, understanding closing costs is essential to
//               maximize your profit. These costs may include agent commissions,
//               title fees, and taxes.
//             </p>

//             <p>
//               Working with the right agent ensures you negotiate effectively and
//               reduce unnecessary expenses.
//             </p>

//             <p>
//               Always review your closing statement carefully and ask questions
